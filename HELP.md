...
* The original package name 'zenika.entretien.spring.reactif.spring-kafka' is invalid and this project uses 'zenika.entretien.spring.reactif.springkafka' instead.
